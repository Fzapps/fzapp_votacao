...
public class AssociadoControllerTest {
    ...
    private static final String CPF = "12345678090";
    ...
    @Test
    public void quandoNãoInformarNumeroCPFNaoDeveCriarAssociado() throws Exception {
        mvc.perform(post("/associado")
                        .contentType(MediaType.APPLICATION_JSON)
				        .param("nome", NOME))
    ...
    public void quandoConsultarUmAssociadoExibirUnico() throws Exception {
        when(repository.findByNumeroCPF(any()))
