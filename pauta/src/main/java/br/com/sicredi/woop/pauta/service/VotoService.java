...
public class VotoService {
	...
	public Pauta votar(String idPauta, Voto voto) {
        ...
        validaAssociadoValido(voto.getNumeroCPF());
        validaVotoRepetido(voto.getNumeroCPF(), pauta.getSessao().getVotos());
	...
	private void validaVotoRepetido(String numeroCPF, Collection<Voto> votos) {
		Optional<Voto> temVoto = votos.stream()
							            .filter(v -> v.getNumeroCPF().equals(numeroCPF))
							            .findFirst();
